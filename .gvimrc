...
"
" ### .gvimrc(Local)
command! EditgVimrcHome :tabe $HOME/.gvimrc
command! ReadgVimrcHome :source $HOME/.gvimrc
nnoremap <Leader>eg :EditgVimrcHome<CR>
nnoremap <Leader>rg :ReadgVimrcHome<CR>
" }}}
"
" ## font
" {{{
